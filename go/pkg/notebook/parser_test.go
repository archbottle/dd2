...
func getRegexesPath() string {
	...
	return filepath.Join(filepath.Dir(filename), "..", "..", "regexes", "device", "notebooks.yml")
}
...
func getFixturesPath() string {
	...
	return filepath.Join(filepath.Dir(filename), "fixtures", "notebook.yml")
}
...
// TestParse mirrors the PHP NotebookTest fixture assertions.
func TestParse(t *testing.T) {
	...
	for i, tc := range fixtures {
		t.Run("case_"+strconv.Itoa(i), func(t *testing.T) {
			got := factory.NewParser(tc.UserAgent).Parse()
