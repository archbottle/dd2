...
func getRegexesPath() string {
	...
	return filepath.Join(filepath.Dir(filename), "..", "..", "regexes", "device", "car_browsers.yml")
}
...
func getFixturesPath() string {
	...
	return filepath.Join(filepath.Dir(filename), "fixtures", "car_browser.yml")
}
...
// TestParse mirrors the PHP CarBrowserTest fixture assertions.
